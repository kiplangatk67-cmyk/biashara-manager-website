    ...
    <main className="min-h-screen bg-surface">
      ...
      <section className="bg-surface px-5 py-20 sm:px-6 sm:py-28 lg:px-8">
        <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-2">
          <div>
            ...
            <Link
              href="/pricing"
              className="group mt-8 inline-flex items-center gap-2 rounded-xl bg-primary px-6 py-3.5 text-sm font-bold text-white shadow-lg shadow-primary/20 transition hover:bg-primary-dark"
            >
              View Pricing
              <ArrowRight
                size={16}
          ...
          {/* Dashboard visual */}
          <div className="rounded-[32px] bg-slate-950 p-5 shadow-2xl sm:p-7">
      ...
      <section className="px-5 py-20 sm:px-6 sm:py-24 lg:px-8">
        <div className="mx-auto max-w-5xl rounded-[32px] bg-primary p-8 text-center text-white shadow-2xl shadow-primary/20 sm:p-12">
          ...
          <Link
            href="/pricing"
            className="group mt-7 inline-flex items-center gap-2 rounded-xl bg-white px-6 py-3.5 text-sm font-bold text-primary shadow-lg transition hover:bg-slate-50"
          >
            Get Started
            <ArrowRight
              size={16}
